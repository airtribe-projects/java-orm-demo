...
import com.airtribe.orm.demo.repositories.redis.base.BaseCacheRepository;
import org.springframework.stereotype.Component;

@Component
public class ProductRedisRepository extends BaseCacheRepository<CachedProductEntity> {
    /**
    ...
    protected ProductRedisRepository(ICacheManager cacheManager) {
        super(cacheManager);
    }
