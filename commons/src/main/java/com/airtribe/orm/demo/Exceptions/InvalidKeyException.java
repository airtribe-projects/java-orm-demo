...
public class InvalidKeyException extends Exception {
  ...
  /**
   * Constructs a {@link InvalidKeyException} with {@code null} as its detail message. The cause is
  ...
  /**
   * Constructs a {@link InvalidKeyException} with the specified detail message.  The cause is not
  ...
  /**
   * Constructs a {@link InvalidKeyException} with the specified detail message and cause.  <p>Note
   * that the detail message associated with {@code cause} is <i>not</i> automatically incorporated
  ...
  /**
   * Constructs a {@link InvalidKeyException} with the specified cause and a detail message of
  ...
  /**
   * Constructs a {@link InvalidKeyException} with the specified detail message, cause, suppression
